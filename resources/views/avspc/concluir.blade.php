...
<div style="padding-left: 50px, padding-right: 50px" class="container">
    <div class="row justify-content-between" style="padding-left: 5%">
        ...
        <div class="col-4">
            <a href="/rotaspc/rotas/{{ $av->id }}" type="submit" class="btn btn-active btn-ghost"> Voltar!</a>
        </div>
...
<div id="av-create-container" class="container">
        ...
        <form action="/avs/salvarCalculoRotaPc" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="text" value="{{ $av->id }}" id="id" name="id" hidden="true">
