...
<div>
    <div class="row" style="padding-left: 5%">
        ...
        <div class="col-1">
            <a href="/rotas/rotas/{{ $av->id }}" type="submit" class="btn btn-active btn-warning"> Voltar!</a>
        </div>
        ...
        <form action="/avs/enviarGestor/{{ $av->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-start" style="padding-left: 5%">
                ...
                <div class="col-12 col-md-2" style="padding-top: 20px">
                    <a href="#" class="btn btn-active btn-success btn-lg">Calcular</a>
                    <br><br>
                    <div>
