...
@section('title', 'Avaliar Prestação de Contas')

@section('content_header')
    <h1>Avaliar Prestação de Contas - Financeiro</h1>
@stop
                                            ...
                                            <div class="col-md-6">
                                                <form action="/avs/financeiroAprovaPrestacaoContas" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    @method('PUT')
                                                        ...
                                                        <label for="comentario">Enviar PC para aprovação do Gestor: </label>
                                                        <br>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="input-group-append">
                                                                <button type="submit" class="btn btn-active btn-success" onclick="exibirLoader()">Aprovar PC</button>
                                                            </span>
                                                        </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form action="/avs/financeiroReprovaPrestacaoContas" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                        <input type="text" hidden="true" id="id" name="id" value="{{ $av->id }}">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="input-group-append">
                                                                <button type="submit" class="btn btn-active btn-danger" onclick="exibirLoader()">Reprovar PC</button>
                                                            </span>
                                                        </div>
