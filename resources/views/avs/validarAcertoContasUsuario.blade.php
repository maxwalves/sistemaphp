...
@section('title', 'Validar Acerto de Contas')
...
<div class="row">
    <div class="col-md-8">
        <h3>Validar Acerto de Contas</h3>
    </div>
    <div class="col-md-4">
                            ...
                            <div class="box box-40">
                                <div>
                                    <div class="box box-40">
                                        <div style="overflow-x: auto;">
                                            <h5 style="color: red">Insira algum comprovante referente ao acerto de contas caso necessário:</h5><br>
                                            <div class="col-3">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <form action="/avs/usuarioReprovarAcertoContas" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                    <input type="text" hidden="true" id="id" name="id" value="{{ $av->id }}">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <span class="input-group-append">
                                                            <button type="submit" class="btn btn-active btn-danger" onclick="exibirLoader()">Reprovar</button>
                                                        </span>
                                                    </div>
