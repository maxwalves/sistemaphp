            ...
            <div >
                <div class="row">
                    ...
                    <div style="border: 1px solid black; padding-left:10px">
                        <p><strong>Data de criação: </strong> {{ date('d/m/Y', strtotime($av->dataCriacao)) }} </p>
                    ...
                    <div style="border: 1px solid black; padding-left:10px">
                        ...
                        <p><strong>Valor em dolar:</strong> R$ {{ $av->valorDolar }},00</p>
                        <p><strong>Valor extra em reais:</strong> R$ {{ $av->valorExtraReais }},00</p>
                        <p><strong>Valor extra em dólar:</strong> R$ {{ $av->valorExtraDolar }},00</p>
                ...
                <table id="tabelaRota" class="comBordaSimples " >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"> {{ date('d/m/Y H:m', strtotime($rota->dataHoraSaida)) }} </td>

                            <td>-</td>
                            <td style="text-align: center">{{$rota->isViagemInternacional == 0 ? $rota->cidadeDestinoNacional : $rota->cidadeDestinoInternacional}} </td>
            
                            <td style="text-align: center"> {{ date('d/m/Y H:m', strtotime($rota->dataHoraChegada)) }} </td>
