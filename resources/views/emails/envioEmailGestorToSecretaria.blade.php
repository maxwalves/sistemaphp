                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10t">
                                                                                        <p style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Existe uma nova Autorização de Viagem (AV: {{ $idAv }}) do usuário {{ $user->name }} que precisa da avaliação da CAD - Coordenadoria Administrativa.</p>
