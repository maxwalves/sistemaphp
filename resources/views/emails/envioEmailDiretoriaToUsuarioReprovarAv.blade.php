                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10t">
                                                                                        <p style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">A DAF reprovou a sua Autorização de Viagem Nr: {{ $idAv }}. Realize a correção e submeta novamente para validação!</p>
